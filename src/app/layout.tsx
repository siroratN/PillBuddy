	...
	return (
		<html lang="en">
			<body className={cn('min-h-screen, bg-background font-sans antialiased', inter.variable)}>
				{children}
				<nav className='shadow-md border fixed flex items-center justify-between bottom-0 w-full h-16 px-12 py-2'>
					<Link href={"/"} className='text-gray-500 hover:text-black'><Calendar size={36} /></Link>
